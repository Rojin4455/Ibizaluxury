...
class Contact(models.Model):
    ...
    property_status = models.CharField(max_length=20, null=True, blank=True)
    preferred_location = models.CharField(max_length=255, null=True, blank=True)
    budget = models.TextField(null=True, blank=True)
    weekly_price_range = models.TextField(null=True, blank=True)
    rental_property_type = models.CharField(max_length=255, null=True, blank=True)
    checkin_date = models.CharField(max_length=50, null=True, blank=True)
